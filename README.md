...
- **Reliable browser tool** — `browser` is a deterministic primitive inside that loop for "open browser / open URL / new tab / new window", verified with both window state and a screenshot
